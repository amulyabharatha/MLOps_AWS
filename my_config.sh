export SG_ROLE= arn:aws:iam::657605447075:role/service-role/AmazonSageMaker-ExecutionRole-20230911T144832 #An AWS IAM Role with Full SG Access (I give full S3 Access too fwiw )
